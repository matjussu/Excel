...
if __name__ == "__main__":
    ...
    for file_name in files:
        ...
        with pd.ExcelWriter(output_file, engine='xlsxwriter') as writer:
            ...
            if nb_call_apres > 0:
                ...
                df_empty_call = pd.DataFrame({
                    ...
                    "Info": ["1. La feuille 'Call Log' existe dans le fichier source"],
                    "Info2": ["2. La colonne 'Parties' contient des données valides"],
        ...
        if nb_call_apres > 0:
            ...
            print(f"  ⚠ Feuil_Call : 0 entrées (feuille créée avec message d'erreur)")
